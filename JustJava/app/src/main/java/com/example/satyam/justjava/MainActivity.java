package com.example.satyam.justjava;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT,
                getString(R.string.order_summary_email_subject, name));//Intent.EXTRA_SUBJECT is used for subject of the email
        intent.putExtra(Intent.EXTRA_TEXT, message);//Intent.EXTRA_TEXT is used for body of the email
